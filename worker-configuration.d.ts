/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eb304b804b295d5cea9fecdfef23336a)
// Runtime types generated with workerd@1.20260903.1 2025-01-01 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	WORKER_MODEL: "@cf/meta/llama-3.1-8b-instruct";
	VALIDATOR_MODEL: "@cf/meta/llama-3.1-70b-instruct";
	REPORT_MODEL: "@cf/meta/llama-3.1-70b-instruct";
	ENGAGEMENT_AGENT: DurableObjectNamespace<import("./src/index").EngagementAgent>;
	RECON_SANDBOX: DurableObjectNamespace<import("./src/index").ReconSandbox>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "EngagementAgent" | "ReconSandbox";
	}
